...
/**
 * Shared context between step definition classes using Cucumber's PicoContainer. Stores state
 * relevant to the current scenario's request and response cycle.
 */
