...
public class RequestLoggingFilter implements Filter {
    ...
    public Response filter(FilterableRequestSpecification requestSpec, FilterableResponseSpecification responseSpec, FilterContext context) {
        ...
        sb.append("Headers:\n");
        requestSpec.getHeaders().forEach(h -> sb.append("  ").append(h.getName()).append(": ").append(h.getValue()).append("\n"));
        ...
        response.getHeaders().forEach(h -> sb.append("  ").append(h.getName()).append(": ").append(h.getValue()).append("\n"));
